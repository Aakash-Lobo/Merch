...
<section class="">
    <div class="container-fluid row">
        ...
        <?php endif; ?>
        <div class="<?php echo isset($_GET['c'])? 'col-md-9': 'col-md-10 offset-md-1' ?> text-black-50">
            ...
            <div class="tab-content pt-2 text-black-50">
                <div class="tab-pane fade show active" id="book">
                    <?php 
                            if(isset($_GET['search'])){
                                echo "<h4 class='text-center py-4'><b>Search Result for '".$_GET['search']."'</b></h4>";
                            }
                        ?>
