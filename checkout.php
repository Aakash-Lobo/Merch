...
endwhile;
?>
<section class="text-black-50" style="width:100%;padding-top:150px">
    <div class="container">
        <div class="card" style="border-radius:32px;"rounded-0">
            ...
            <form action="" id="place_order">
                <form class="row g-3">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <input class="form-control" type="text" name="Name" placeholder="Name" aria-label="Name"><br>
                        </div>
                        <div class="col-sm">
