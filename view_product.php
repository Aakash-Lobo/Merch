...
?>
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5 text-black-50 ">
        
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6">
                <img loading="lazy" id="display-img" src="<?php echo validate_image($img) ?>" alt="..." />
            ...
            <div class="col-md-6">
                ...
                <h3 class="display-5 fw-bolder border-bottom border-primary pb-1"><?php echo $brand ?></h3>
                ...
                <br>
                <p class="lead"><b>PRODUCT DETAILS :</b><br><?php echo stripslashes(html_entity_decode($description)) ?></p>
